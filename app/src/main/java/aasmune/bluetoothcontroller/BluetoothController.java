...
public class BluetoothController extends AppCompatActivity {
    ...
    private BluetoothAdapter.LeScanCallback mLeScanCallback = new ScanCallback() {

        @Override
        public void onScanResult(int callbackType, ScanResult result) {

            super.onScanResult(callbackType, result);
            sDevice = result.getDevice();

            if(sDevice.getName() == null){
                return;
            }
            ...
            if(sDevice.getName().startsWith("Ba")){
                subscription = sDevice.connectGatt(getApplicationContext(), true, joinGatt);
...
public class BluetoothController extends ListActivity {
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public LeDeviceListAdapter() {
            ...
            mInflator = BluetoothController.this.getLayoutInflater();
        }
